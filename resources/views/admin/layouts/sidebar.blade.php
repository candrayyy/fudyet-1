  <div class="border-end" id="sidebar-wrapper">
                ...
                <div class="list-group">
                    ...
                    <a class="list-group-item list-group-item-action p-3" href={{'blood-fact'}}>Blood Fact</a>
                    <a class="list-group-item list-group-item-action p-3" href={{'allergy-fact'}}>Allergy Fact</a>
